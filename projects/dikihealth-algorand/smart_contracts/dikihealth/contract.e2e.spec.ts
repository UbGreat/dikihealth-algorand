...
import { DikihealthFactory } from '../artifacts/dikihealth/DikihealthClient'

describe('Dikihealth contract', () => {
  ...
  const deploy = async (account: Address) => {
    const factory = localnet.algorand.client.getTypedAppFactory(DikihealthFactory, {
